...
public class BestServiceAdapter extends ArrayAdapter<Service> {

    private Context context;
    private TechnicianDataSource technicianDataSource;
    private ReviewDataSource reviewDataSource;

    public BestServiceAdapter(@NonNull Context context, @NonNull List<Service> services, TechnicianDataSource techDS, ReviewDataSource reviewDS) {
